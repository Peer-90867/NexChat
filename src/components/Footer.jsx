import { MessageSquare, Twitter, Github, Disc } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-400 max-w-sm mb-6">
              A modern real-time chat platform with end-to-end encryption, file sharing, and private messaging.
            </p>
